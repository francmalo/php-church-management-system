...
<script>
        function addFamilyMember() {
            ...
            // Create a new div element for the family member
            var memberDiv = document.createElement('div');
            memberDiv.classList.add('form-group');

            // Add input fields for full name, email, and phone number
            memberDiv.innerHTML = `
  ...
  <body>
              ...
              <ul class="menu-sub">
                <li class="menu-item active">
                  <a href="create_user.php" class="menu-link">
                    <div data-i18n="Vertical Form">Create User</div>
                  </a>
                </li>
                <li class="menu-item">
              ...
              <ul class="navbar-nav flex-row align-items-center ms-auto">
                ...
                <li class="nav-item navbar-dropdown dropdown-user dropdown">
                  ...
                  <ul class="dropdown-menu dropdown-menu-end">
                    ...
                    echo '<span class="fw-semibold d-block">' . $_SESSION['user_username'] . '</span>';
                } else {
                    // Handle the case when username is not set in the session
                    echo '<span class="fw-semibold d-block">Guest</span>';
                }
                ?>
    ...
    ?>
            ...
            <button type="button" onclick="addFamilyMember()" class="btn btn-primary">Add Family Member</button>
